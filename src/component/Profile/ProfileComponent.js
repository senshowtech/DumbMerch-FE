        ...
        <div className="col-12 col-lg-5">
          ...
          {transactions?.map((value) => {
            return (
              <div
                key={value.id}
                className="box-profile d-flex align-items-center mt-3"
              >
